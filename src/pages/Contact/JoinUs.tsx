        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-yellow-400 p-4 rounded-md">
            <p className=" my-auto  text-xl p-5">
              ...
              and considers all applicants on the basis of merit without regard
              to race, religion, sex, gender identity, sexual orientation,
              ethnicity, national origin, age, marital status, or disability.
            </p>
          </div>
        </div>
      </div>
